...
class PatientsController extends ChangeNotifier {
  ...
  Future<void> loadPatients() async {
    ...
    try {
      ...
      AppLogger.error('Error loading patients', e);
      _allPatients = [];
      _filteredPatients = [];
    } finally {
      _isLoading = false;
  ...
  Future<bool> addPatient(PatientModel patient) async {
    try {
      ...
      AppLogger.error('Error adding patient', e);
      return false;
    }
  }
  ...
  Future<bool> updatePatient(PatientModel patient) async {
    try {
      ...
      AppLogger.error('Error updating patient', e);
      return false;
    }
  }
  ...
  Future<bool> deletePatient(PatientModel patient) async {
    try {
      ...
      AppLogger.error('Error deleting patient', e);
      return false;
    }
  }
  ...
  Future<bool> toggleSyncStatus(PatientModel patient) async {
    try {
      ...
      AppLogger.error('Error toggling patient sync status', e);
      return false;
    }
  }
